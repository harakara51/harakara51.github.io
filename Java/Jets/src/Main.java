...
public class Main
{
	...
	public static ArrayList<Pilot> pilotList= new ArrayList<Pilot>();
		...
		while (true)
		{
			...
			if (userChoice == 1)
			{
				for (int i = 0; i < Jets.size(); i++)
				{
					...
					Jets.get(i).display();
					System.out.print(pilotList.get(i).getName());
					System.out.println("");
			}
	...
	public static Pilot hirePilots(Scanner keyboard)
	{
		String name = " ";
		int experience = 0;
	...
	public static void makeFleet()
	{
		...
		Pilot Bob = new Pilot("bob",3,true);
		Pilot Mano = new Pilot("Mano",5,true);
		Pilot Jeff = new Pilot("Jeff",7,true);
		Pilot Maya = new Pilot("Maya",4,true);
		Pilot Ted  = new Pilot("Ted",3,true);
		Pilot Molly  = new Pilot("Molly",3,true);
		
		
		Jets B737C1 = new Jets(560, 3600, 189, 65000000, "B737",Bob );
		Jets B747C1 = new Jets(570, 8300, 580, 357000000, "B747",Mano);
		Jets B747C2 = new Jets(570, 8300, 580, 357000000, "B747", Jeff);
		Jets B777C1 = new Jets(570, 11000, 451, 286000000, "B777",Maya );
		Jets B777C2 = new Jets(590, 12000, 451, 296000000, "B777", Ted );
		
		//adding objects to respective arraylist
	...
	public static void newJet(Scanner keyboard)
	{
		...
		Pilot newHire = hirePilots(keyboard);

		Jets.add(new Jets(speed, range, capacity, price, model, newHire));
